...
class ImpCov(object):
    ...
    def execute(self, parameters, messages):
        try:
			...
			# Created on: 2016-03-05 20:28:14.00000
			...
			# Process: Divide
			arcpy.gp.RasterCalculator_sa("\"%FA_weight%\" / \"%DEM_fa%\"", FA_impervPerc)

			# Process: Reclassify
			arcpy.gp.Reclassify_sa(FA_impervPerc, "Value", "0 10 1;10 20 2;20 30 3;30 40 4;40 50 5;50 60 6;60 70 7;70 80 8;80 90 9;90 100 10", Imperv_reclass, "DATA")
